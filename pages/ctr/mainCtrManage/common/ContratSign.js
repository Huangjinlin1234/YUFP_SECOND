      ...
      data: function () {
        return {
          ...
          GuarTableFields: [
            ...
            { label: '纸质担保合同编号', prop: '', width: 120 }, // 授信合同
            { label: '担保人客户编号', prop: '', width: 120 }, // 借款合同
          ...
          LoanTableFields: [
            { label: '借款合同编号', prop: '', width: 120 },
            { label: '客户编号', prop: '', width: 120 },
            { label: '客户名称', prop: '', width: 120 },
            { label: '合同类型', prop: '', width: 120, dataCode: 'htlx' },
            { label: '主担保方式', prop: '', width: 120, dataCode: 'zdbfs' },
            { label: '币种', prop: '', width: 120, dataCode: 'bz' },
            { label: '合同金额(元)', prop: '', width: 120 },
            { label: '合同状态', prop: '', width: 120, dataCode: 'htzt' },
            { label: '签约日期', prop: '', width: 120, dataCode: '' },
            // { label: '登记人', prop: 'inputId', width: 120, dataCode: '' },
            // { label: '登记机构', prop: 'inputBrId', width: 120, dataCode: '' },
          ],
