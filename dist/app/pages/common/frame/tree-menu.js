/**
 * Created by jiangcheng on 2017/11/16.
 */
define(function (require, exports, module) {
  ...
  var treeMenu = (function () {
    ...
    var handleSidebarMenu = function (idxMenuSwiper) {
      jQuery('.page-sidebar').on('click', 'li > a', function (e) {
        ...
        parent.children('li.open').children('.sub-menu').slideUp(200, function () {
          idxMenuSwiper.resizeFix();
        });
        parent.children('li.open').removeClass('open');
        parent.children('li').children('.sub-menu').each(function () {
          if ($(this).is(':visible')) {
    ...
    var handleTooltips = function () {
      if (treeMenu.isTouchDevice()) { // if touch device, some tooltips can be skipped in order to not conflict with click events
    ...
    return {
      ...
      init: function (idxMenuSwiper) {
        ...
        handleSidebarMenu(idxMenuSwiper); // handles main menu
        ...
        treeMenu.addResponsiveHandler(handleChoosenSelect); // reinitiate chosen dropdown on main content resize. disable this line if you don't really use chosen dropdowns.
      },
